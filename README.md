...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/async-exit-stack-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12380&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/async-exit-stack-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `async-exit-stack` can be installed with:

```
conda install async-exit-stack
```

It is possible to list all of the versions of `async-exit-stack` available on your platform with:
